...
def fit_line(experiment_data):
    ...
    [slope, intercept], errors = fit_func(linear_func, experiment_data['water_temp'], experiment_data['rate_of_evaporation'])
...
if __name__ == '__main__':
    experiment_data = {'rate_of_evaporation': [2.20e-07, 2.48e-6, 3.53e-6, 6.55e-6],
                       'water_temp': [40, 70, 79, 91],
                       'roe_error': [3.59e-09, 7.9e-8, 9.8e-8, 6.9e-8],
                       'temp_error': [1.5] * 4}
